...
# ------------------------------------------------------------------------------
# Modified (a bit) by Evgeny Levinkov (evgeny.levinkov@gmail.com)
# ------------------------------------------------------------------------------
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, num_classes, num_input_channels):
        extra = config.MODEL.EXTRA
        super(HighResolutionNet, self).__init__()

        # stem net
        self.conv1 = nn.Conv2d(num_input_channels, 64, kernel_size=3, stride=2, padding=1,
                               bias=False)
